...
export default function Home() {
  const onSubmit1 = (e: { preventDefault: () => void }) => {
    e.preventDefault()
  ...
  const onSubmit2 = (e: { preventDefault: () => void }) => {
    e.preventDefault()
    axios.get('http://detector.com:8071/api/v1/crawl').then((response) => {
      console.log('====================================')
      console.log('response', response)
      ...
      <div className='container'>
        <div className='grid grid-cols-1 lg:grid-cols-5  lg:py-32 lg:pr-10'>
          <div className='lg:col-span-2 lg:col-start-4 justify-center'>
            <form className='p-10 rounded bg-white shadow-sm' noValidate onSubmit={onSubmit1}>
            ...
            <form className='p-10 rounded bg-white shadow-sm' noValidate onSubmit={onSubmit2}>
              <div className='mt-3'>
                <button
                  type='submit'
                  className='w-full  py-4 px-2 uppercase bg-red-500 text-white text-sm hover:bg-red-600 flex justify-center items-center'
